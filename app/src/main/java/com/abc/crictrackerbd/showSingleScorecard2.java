...
public class showSingleScorecard2 extends Activity {
    ...
    TextView thirdInnings;
    TextView fourthInnings;
    TextView date;
    Button link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_single_scorecard2);
        ...
        thirdInnings = findViewById(R.id.thirdInnings_value);
        fourthInnings = findViewById(R.id.fourthInnings_value);
        ...
        format = getIntent().getStringExtra("ScorecardFormat");
        showSingleScorecardDatabaseRef = FirebaseDatabase.getInstance().getReference("scorecard/"+ format+ "/" + key);
        ...
        showSingleScorecardDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                thirdInnings.setText(scorecard.getThirdInnings());
                fourthInnings.setText(scorecard.getFourthInnings());
    ...
    private void takeToEditScorecard(View v) {
        Intent intent = new Intent(this,editScorecard2.class);
