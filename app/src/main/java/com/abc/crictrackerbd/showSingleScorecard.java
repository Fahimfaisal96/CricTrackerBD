...
public class showSingleScorecard extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_single_scorecard);
    ...
    private void takeToEditScorecard(View v) {
        Intent intent = new Intent(this,editScorecard.class);
