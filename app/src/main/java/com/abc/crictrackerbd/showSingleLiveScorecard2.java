...
public class showSingleLiveScorecard2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_single_live_score_card2);
    ...
    private void takeToEditScorecard(View v) {
        Intent intent = new Intent(this,editLiveScorecard2.class);
