...
public class editLiveScorecard2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_live_scorecard2);
    ...
    private void goToEditScorecard() {
        ...
        scorecardDatabaseRef.setValue(changedScorecard).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(editLiveScorecard2.this,"Update Done",Toast.LENGTH_LONG).show();
            }
        });
